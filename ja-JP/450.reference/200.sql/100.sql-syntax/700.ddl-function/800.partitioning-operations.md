...
seekdbのパーティション操作には、リパーティション、パーティションの追加、パーティションの削除、およびパーティションのクリアが含まれます。

## リパーティション

リパーティションの構文は以下のとおりです：
...
#### 1次Hashパーティションテーブルを、テンプレート化されたHash+Rangeの2次パーティションテーブルに変更する例
...
#### Hash + Rangeの2次パーティションテーブルをRange Columns+Range Columnsパーティションに変換する例
