...
seekdbにおけるパーティション操作には、リパーティション、パーティションの追加、パーティションの削除、およびパーティションのクリアが含まれます。
...
#### パーティションHashテーブルを、スキーマ型Hash+Rangeサブパーティションテーブルに変更する例
...
#### Hash + RangeサブパーティションテーブルをRange Columns+Range Columnsパーティションに変換する例
