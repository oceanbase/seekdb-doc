...
| no_invalidate   | 統計情報収集時にプランキャッシュをフラッシュするかどうかを指定します。`TRUE`に設定すると、統計情報収集時にプランキャッシュをフラッシュしません。    |

## 例外状況

|    エラーコード    |         説明       |
|-----------|---------------------|
| HY000     |  <ul><li>オブジェクトが存在しないか、権限が不足しています。</li><li>無効または一貫性のない値。</li><li>統計情報を復元できません。統計履歴情報は利用できません。</li></ul>     |
