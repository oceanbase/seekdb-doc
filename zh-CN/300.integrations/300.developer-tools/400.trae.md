...
<Tabs>
  <TabItem value="seekdb Agent Skill 与 Trae 集成" label="seekdb Agent Skill 与 Trae 集成" default>
    ...
    seekdb Agent Skills 是基于该标准构建的「可被 AI 自动调用的知识包 + 工作流」。在 Trae 中安装后，当你提问 seekdb 相关问题时，Trae 的 AI 会自动按技能说明查阅 seekdb 文档或执行数据导入导出等操作，无需记住命令或手动复制文档，即可在编码过程中获得 seekdb 的官方文档支持与实操能力。更多关于 Agent Skill 的信息，请参考 [seekdb Agent Skills]((../../100.get-started/110.use-seekdb-with-skill/100.agent-skills.md))。
  ...
  <TabItem value="seekdb MCP Server 与 Trae 集成" label="seekdb MCP Server 与 Trae 集成">
