...
seekdb 的 Json Partial Update 功能默认是不开启的，开关由系统变量 `log_row_value_options` 控制，详细信息，参见 [log_row_value_options](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015916)。
