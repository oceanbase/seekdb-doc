...
For detailed requirements, see [Dense vector index](../300.dense-vector-index/100.dense-vector-index-overview.md). Here, only the special requirements for sparse vector indexes are described:
...
* For index memory estimation and actual usage query of vector indexes, see [Index memory estimation and actual usage query](../200.vector-index-memory-management.md).