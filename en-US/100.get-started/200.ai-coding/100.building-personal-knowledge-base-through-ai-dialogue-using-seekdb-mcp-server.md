...
For more information about seekdb MCP server, see [seekdb MCP server](https://www.oceanbase.ai/docs/seekdb-mcp-server).
...
- Embedded-mode seekdb is supported on **Linux** (glibc >= 2.28, x86_64 or aarch64) and **macOS 15 or later**. Make sure your system meets the requirements.
- You have installed Cursor or another MCP-compatible tool (for example, Windsurf or Qoder).
- You have Python installed (version 3.11~3.13). Download it from the [official Python site](https://www.python.org/downloads/).
