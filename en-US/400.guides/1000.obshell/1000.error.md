...
| Agent.IP.InconsistentWithseekdb | Agent IP inconsistent with seekdb | The obshell node IP does not match the seekdb node IP | Please check the IP configuration. |
...
| Agent.OBVersionNotSupported | Unsupported ob version '%s', the minimum supported version is '%s' | The current seekdb version is not supported | Please use a supported seekdb version. |
...
| Agent.OceanBase.NotHold | Agent is not holding seekdb | The obshell node does not have an seekdb connection | Please restart the obshell node and try again. |
...
| Agent.OceanBase.Useless | The current database is useless | The current seekdb is unavailable | Please check whether seekdb is available. |
...
| Agent.Start.ObserverFailed | Start seekdb via flag failed | Failed to start seekdb | Please check seekdb configuration. |
...
| OB.Binary.Version.Unexpected | Unexpected seekdb binary version. | seekdb version is unexpected | Please contact the OceanBase technical support team for troubleshooting. |
