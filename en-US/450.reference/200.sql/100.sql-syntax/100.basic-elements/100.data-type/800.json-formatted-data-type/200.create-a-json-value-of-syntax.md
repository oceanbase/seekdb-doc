...
1. Enable semi-structured encoding
   ...
   * Example of enabling semi-structured encoding when you create a table
      ...
      For more information about the syntax, see [CREATE TABLE](../../../600.sql-statement/2600.create-table.md).
   ...
   * Example of enabling semi-structured encoding for an existing table
      ...
      For more information about the syntax, see [ALTER TABLE](../../../600.sql-statement/1600.alter-table.md).
