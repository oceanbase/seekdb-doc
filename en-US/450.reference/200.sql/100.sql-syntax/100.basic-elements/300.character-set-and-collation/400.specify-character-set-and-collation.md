...
In the preceding syntax, the `CHARACTER SET` and `COLLATE` clauses can be used to create databases with different character sets and collations on the same seekdb.
